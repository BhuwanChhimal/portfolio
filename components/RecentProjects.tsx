          ...
          >
            ...
            >
              ...
              <div className="flex items-center justify-between mt-7 mb-3">
                ...
                <a target="/blank" href={item.link} className="flex justify-center items-center hover:scale-105 border-2 rounded-full p-2">
                  <p className="flex lg:text-xl md:text-xs text-sm text-purple  hover:text-violet-400">
                     Link
                  </p>
                  <FaLocationArrow className="ms-3" color="#CBACF9" size={20}/>
                </a>
              </div>
            </PinContainer>
          </div>
